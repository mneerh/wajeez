...
class _MyTicketsWidgetState extends State<MyTicketsWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.userTickets = await TicketTable().queryRows(
        queryFn: (q) => q.eqOrNull(
          'user_id',
          currentUserUid,
        ),
      );
      _model.numTickets = _model.userTickets?.length;
      safeSetState(() {});
    });
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        ...
                        image: Image.asset(
                          Theme.of(context).brightness == Brightness.dark
                              ? 'assets/images/dark2_No_tickets_avaliable.png'
                              : 'assets/images/No_tickets_avaliable.png',
                        ).image,
                      ),
                    ),
                    child: Align(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        FutureBuilder<List<TicketRow>>(
                          future: TicketTable().queryRows(
                            queryFn: (q) => q
                                .eqOrNull(
                                  'user_id',
                                  currentUserUid,
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<TicketRow> listViewTicketRowList =
                                snapshot.data!;
                            ...
                            return ListView.builder(
                              ...
                              itemCount: listViewTicketRowList.length,
                              itemBuilder: (context, listViewIndex) {
                                final listViewTicketRow =
                                    listViewTicketRowList[listViewIndex];
                                return Card(
