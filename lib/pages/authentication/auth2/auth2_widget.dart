                                ...
                                children: [
                                  Align(
                                    ...
                                    child: TabBar(
                                      ...
                                      indicatorColor: Color(0xFF415644),
                                      indicatorWeight: 3.0,
                                      tabs: [
                                        Tab(
                                          text: FFLocalizations.of(context)
                                              .getText(
                                            'py5fmci7' /* Create Account */,
                                          ),
                                        ),
                                        Tab(
                                          text: FFLocalizations.of(context)
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'wpyah6hv' /* Let's get started by filling o... */,
                                                        ),
                                                        textAlign:
                                                            TextAlign.start,
                                                        style:
                                                            ...
                                                            Padding(
                                                              ...
                                                              child: Text(
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  'pa935t3p' /* Password do not match */,
                                                                ),
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'ndal7o9b' /* Fill out the information below... */,
                                                        ),
                                                        textAlign:
                                                            TextAlign.start,
                                                        style:
